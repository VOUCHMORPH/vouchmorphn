...
// FIXED: Standardized on getConnection() to match auth.php
...
if ($hasAdminAuth) {
    ...
    addResult('9. Platform/Organization Tier Separation', 'Platform admin uses a DISTINCT session key',
        ...
        !$usesSameSessionKey ? 'No overlap with $_SESSION[\'enterprise_user\'] detected' : 'FAIL — AdminAuth.php references $_SESSION[\'enterprise_user\']',
