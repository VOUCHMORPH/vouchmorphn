...
<head>
    ...
    <title>Beneficiaries · VOUCHMORPH</title>
...
<body>
    ...
    <nav class="nav">
        ...
        <a href="beneficiaries.php" class="nav-item active">👥 Beneficiaries</a>
    ...
    <main class="content">
        ...
        <div class="card">
            ...
            <p style="margin-top: 8px; font-size: 13px; color: #94a3b8;">
                Use the <strong>"Add Destinations"</strong> flow in the disbursement process to add beneficiaries.
            </p>
            <a href="imports/add_destinations.php" class="btn">➕ Add Beneficiaries</a>
        </div>
    </main>
