...
if (!function_exists('svgIcon')) {
    function svgIcon(string $name): string {
        $icons = [
            ...
            'wallet' => '<rect x="3" y="6" width="18" height="13"/><path d="M3 10h18"/><circle cx="16.5" cy="14" r="1"/>',
            'people' => '<circle cx="8.5" cy="8" r="3.2"/><path d="M2.5 19c0-3.3 2.7-5.5 6-5.5s6 2.2 6 5.5"/><circle cx="17" cy="8.5" r="2.6"/><path d="M15.2 15c2.6.3 4.3 2.3 4.3 5"/>',
