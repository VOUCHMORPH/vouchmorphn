...
<head>
    ...
    <title>User Management · VOUCHMORPH</title>
...
<body>
    ...
    <main class="content">
        ...
        <div class="card">
            ...
            <p>This module is under development. User management will be available soon.</p>
            <p style="margin-top: 8px; font-size: 13px; color: #94a3b8;">
                You can manage users through the organization settings once implemented.
            </p>
        </div>
    </main>
