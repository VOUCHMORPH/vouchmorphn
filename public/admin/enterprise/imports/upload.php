        ...
        if (!in_array($extension, $allowed)) {
            ...
            $stmt = $db->prepare("
                INSERT INTO import_batches (
                    ...
                    source_format, status, uploaded_by, total_rows, total_amount, currency
                ) VALUES (
                    :org_id, :ref, :name, :filename, :format, 'UPLOADED', :user_id, 0, 0, 'BWP'
                )
            ");
            $stmt->execute([
                ':org_id' => $orgId,
            ...
            // Store template mapping if selected
