...
<head>
    ...
    <style>
        /* Same styles as before, plus approval workflow */
        :root {
            --paper: #EEF1EF;
            --panel: #FFFFFF;
            --ink-900: #0F2138;
    ...
    <div class="stage">
        ...
        <div class="card">
            ...
            <div class="actions-bar">
                ...
                <button class="btn btn-danger" onclick="if(confirm('Delete this batch?')) window.location.href='delete_batch.php?batch_id=<?php echo $batchId; ?>'">🗑 Delete</button>
                <?php endif; ?>
