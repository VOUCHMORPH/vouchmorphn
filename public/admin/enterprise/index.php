...
// PERFECT ALIGNMENT - Grid-based, no floating elements
...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* ============================================================
           DASHBOARD CONTENT - GRID ALIGNED
           ============================================================ */
        .dashboard-content {
        ...
        /* ============================================================
           STATS GRID - PERFECT 4-COLUMN GRID
           ============================================================ */
        .stats-grid {
            display: grid;
        ...
        /* ============================================================
           QUICK ACTIONS - PERFECTLY ALIGNED
           ============================================================ */
        .quick-actions {
            display: grid;
        ...
        .widget-card .card-header.warn-bg {
            background: var(--warning-bg);
        }

        .widget-card .card-header.blue-bg {
            background: var(--info-bg);
        }
            ...
            <div class="dashboard-content">
                ...
                <div class="card widget-card warn">
                    ...
                    <div class="widget-body">
                        ...
                        <?php if ($stats['pending'] > 0): ?>
                        <a href="batches/index.php?filter=pending" class="action-btn primary" style="display:inline-flex; justify-self:start;">
                ...
                <div class="card widget-card blue">
                    ...
                    <div class="widget-body">
                        ...
                        <a href="reports/audit_trail.php" class="action-btn secondary" style="display:inline-flex; justify-self:start;">
