...
try {
    ...
    if (empty($input['type']) || empty($input['source_id'])) {
        throw new RuntimeException("Missing required fields: type and source_id");
    }
    ...
    $result = $swapService->deletePendingSource($userId, $input['type'], (int)$input['source_id']);
